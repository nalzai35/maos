    ...
    <?php endif; ?>
        ...
        <div class="col-12 mb-5">
            <div class="d-inline-block">
                ...
                <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode_deep( get_the_title() );?>&amp;url=<?php echo urlencode_deep( get_permalink() );?>&amp;via=<?php echo $razthemes['user_twitter'];?>" class="btn btn-tw btn-sm text-white">Twitter</a>
