    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                  'id'       => 'user_twitter',
                  'type'     => 'text',
                  'title'    => __( 'User Twitter', 'maos' ),
                  // 'subtitle' => __( 'You can change logo text in menu', 'maos' ),
                  'desc'     => __( 'Insert the username for the share button (ex:@username) without "@"', 'maos' ),
                  'default'  => 'username',
                ),
            array(
                'id'       => 'favicon',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'      => array(
            ...
            array(
              'id'       => 'bg_color',
              'type'     => 'color',
              'title'    => __( 'Background Color', 'maos' ),
              'transparent' => false,
              'default'  => '#f4f4f4',
            ),
        ...
        'fields'     => array(
          ...
          array(
            ...
            //   'subtitle' => __( 'Paste your Adsense, BSA or other ad code here to show Ads below Primary Nav', 'maos' ),
              'desc'     => __( 'Size Ads: 428x60, 300x250, 336x280, 250x250, 200x200 and Responsive Ads', 'maos' ),
              'type'     => 'ace_editor',
              'mode'     => 'html',
              // 'validate' => 'html',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
          ...
          array(
            ...
            //   'title'    => __( 'Paste Your Code in Here', 'maos' ),
            //   'subtitle' => __( 'Paste your Adsense, BSA or other ad code here to show Ads below Primary Nav', 'maos' ),
              'desc'     => __( 'Size Ads: 720x90, 428x60, 300x250, 336x280, 250x250, 200x200 and Responsive Ads', 'maos' ),
              'type'     => 'ace_editor',
              'mode'     => 'html',
              // 'validate' => 'html',
              // 'default'  => 'No HTML is allowed in here.'
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'      => array(
          ...
          array(
            ...
            // 'subtitle' => __( 'Paste your Adsense, BSA or other ad code here to show ads below your article title on single posts.', 'maos' ),
            'desc'     => __( 'Side Ads: 428x60, 300x250, 336x280, 250x250, 200x200 and Responsive Ads', 'maos' ),
            'type'     => 'ace_editor',
            'mode'     => 'html',
          ),
        )
    ...
    //   'desc'  => __( 'Other Setting Options', 'maos' ),
      ...
      'fields'     => array(
        ...
        array(
          'id'       => 'anti_ucbrowser',
          'type'     => 'switch',
          'title'    => __( 'Anti UC Browser', 'maos' ),
          'subtitle' => __( 'Redirect UC Browser to Chrome (Android).', 'maos' ),
          'on'       => 'Enable',
          'off'      => 'Disable',
          'default'  => 0,
        ),
        ...
        array(
          'id'       => 'anti_operamini',
          'type'     => 'switch',
          'title'    => __( 'Anti Opera Mini', 'maos' ),
          'subtitle' => __( 'Redirect Opera Mini to Chrome (Android).', 'maos' ),
          'on'       => 'Enable',
          'off'      => 'Disable',
          'default'  => 0,
        ),
